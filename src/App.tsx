...
// Ajoutez cette fonction utilitaire avant votre composant App
const useIsMobile = () => {
...
// Dans votre composant App, ajoutez:
function App() {
  // États existants...
        ...
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
          ...
          <div className="text-center mt-12 sm:mt-8 px-2">
            <h2 className="text-xl sm:text-3xl font-bold tracking-tight bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
              SAUREZ-VOUS TROUVER LAQUELLE DE CES VIDÉOS A ÉTÉ GÉNÉRÉE PAR IA ?
            </h2>
          </div>
        </div>
  ...
  // Écran de résultats adapté pour mobile
  let message = "";
  let emoji = "";
  let Icon = Trophy;
